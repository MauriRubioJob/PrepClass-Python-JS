...
!define MULTIUSER_INSTALLMODE_INSTDIR "Pacman"
...
Section "!${PRODUCT_NAME}" sec_app
  ...
  SetOutPath "%HOMEDRIVE%\%HOMEPATH%"
    CreateShortCut "$SMPROGRAMS\Pacman.lnk" "$INSTDIR\Python\pythonw.exe" \
      '"$INSTDIR\Pacman.launch.pyw"' "$INSTDIR\glossyorb.ico"
  SetOutPath "$INSTDIR"
...
Section "Uninstall"
  ...
  ; Uninstall files
    Delete "$INSTDIR\Pacman.launch.pyw"
    Delete "$INSTDIR\glossyorb.ico"
    Delete "$INSTDIR\Player.py"
    Delete "$INSTDIR\Wall.py"
    Delete "$INSTDIR\Ghost.py"
  ; Uninstall directories
    RMDir /r "$INSTDIR\Python"
    RMDir /r "$INSTDIR\assets"

  ; Uninstall shortcuts
      Delete "$SMPROGRAMS\Pacman.lnk"
  RMDir $INSTDIR
